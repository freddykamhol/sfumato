...
function siteMarkup() {
  return `
    ...
    <footer><div class="footer-brand"><img src="/Signatur2.png" alt="Signatur von Leon Zwezich"></div><div><a href="#arbeiten">Arbeiten</a><a href="#about">Studio</a><a href="#termin">Booking</a><a href="#admin">Admin</a></div><div class="social">${instagram}<span>Einbeck</span></div><p>© 2026 Tattoo Sfumato · Einbeck · Impressum · Datenschutz</p></footer><div class="toast" role="status"></div>`
}
