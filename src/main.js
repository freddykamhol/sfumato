...
function initAdmin() {
  ...
  content.addEventListener('click', e => {
    ...
    if(row){
      ...
      content.innerHTML=`<div class="detail-top"><button class="detail-back">← Anfragen</button><div><button class="secondary-action" data-customer="${encodeURIComponent(customerKey(r))}">Kunde öffnen</button><button class="secondary-action" data-question>Rückfrage senden</button><button class="save-settings" data-proposals>Terminvorschläge erstellen</button></div></div>
