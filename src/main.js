...
async function render(){
  ...
  document.querySelector('#app').innerHTML=admin?adminMarkup():referencesPage?allReferencesMarkup():imprintPage?impressumMarkup():privacyPage?privacyMarkup():siteMarkup(); admin?initAdmin():initSite();initLightbox();window.scrollTo(0,0)
}
