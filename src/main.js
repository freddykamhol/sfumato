...
const correctLegalOwner=markup=>markup.replaceAll('Inhaber: Leon Zwezich','Inhaber: Richard Zwezich').replaceAll('Inhaber Leon Zwezich','Inhaber Richard Zwezich').replaceAll('<h2>Redaktionell verantwortlich</h2><p>Leon Zwezich','<h2>Redaktionell verantwortlich</h2><p>Richard Zwezich')
