...
for (const route of ['referenzen', 'impressum', 'datenschutz', 'admin', 'admin/login', 'admin/anfragen', 'admin/referenzen', 'admin/einstellungen', 'admin/einstellungen/schnittstellen', 'admin/einstellungen/benutzer', 'admin/einstellungen/kalender', 'admin/einstellungen/assistent', 'admin/termin-neu', 'admin/terminakten', 'admin/kunden', 'admin/importe']) {
