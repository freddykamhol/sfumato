...
const html = readFileSync(target, 'utf8').replace('<meta name="theme-color" content="#0b0b0b">', '<meta name="theme-color" content="#0b0b0b"><link rel="icon" href="/favicon.svg" type="image/svg+xml">')
